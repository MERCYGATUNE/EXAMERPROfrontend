...
const AdminDashboardExams = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('http://0.0.0.0:5555/get_exams', {
        method: 'GET',
        headers: {
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch('http://0.0.0.0:5555/update_exam', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDelete = async (exam_id) => {
    try {
      const response = await fetch('http://0.0.0.0:5555/delete_exam', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
